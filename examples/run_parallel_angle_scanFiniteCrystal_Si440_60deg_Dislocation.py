...
comment = 'FiniteCrystal_Si440_60deg_Dislocation'

print('Running simulation for: ', comment)

def single_realization(delta_theta):
    
    xcr = XCrystal(XCr_path+'/config/Si440_17p45keVDislk60degGronkowskiFiniteCrystal3Dpar.yaml')
...
if __name__ == '__main__':
    ...
    filename1 = 'run_angle_U1' + '_' + str(n_cycle) + '_' + str(n_par) + '_' + comment
    filename2 = 'run_angle_U2' + '_' + str(n_cycle) + '_' + str(n_par) + '_' + comment
