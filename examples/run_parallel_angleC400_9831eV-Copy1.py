...
comment = 'angleC400_9p8keV_waist_250_micronsPhase1'
...
def single_realization(delta_theta):
    ...
    return np.asarray([delta_theta, xcr.Reflectivity, xcr.PhaseRefl])
...
if __name__ == '__main__':
    ...
    delta_theta = np.linspace(14.8e-6,15.2e-6, Npoints)    
