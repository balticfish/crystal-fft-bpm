...
def single_realization(delta_theta, w_ind):
    ...
    xcr = XCrystal(XCr_path+'/config/C333_Omega12p8keV_waist50um.yaml', omega)
    xcr.configure(delta_theta,0, E_wxy_sim[w_ind,:,:])
    xcr.run3D()
